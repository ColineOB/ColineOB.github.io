...
export default function HeroSection() {
  ...
  return (
    <section className="flex min-h-screen flex-col-reverse justify-center gap-8 px-6 lg:flex-row lg:items-center lg:px-20">
      ...
      >
        <h1 className="decoration-tulip-tree-500 mb-4 text-2xl font-black underline md:text-5xl">
          Web Développeuse
        </h1>
      ...
      <div
        aria-hidden="true"
        className="text-steel-gray-500 neumorph-text animate-fade-in-up pointer-events-none transform select-none text-center text-[14vw] font-black uppercase leading-none sm:text-[12vw] md:text-[9vw] lg:pt-4 lg:text-right"
      >
        Coline
        <br />
        Cantelou
